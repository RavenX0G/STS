package com.mogul.xxm.sts.widget;
...
import com.mogul.xxm.sts.utils.DensityUtil;


/**
  Created by wangyang on 2017/11/22 0026.
 * 提示Dialog
 */
...
public class MStatusDialog {
    ...
    private void configView() {
        ...
        myGrad.setStroke(DensityUtil.dp2px(mContext, mBuilder.strokeWidth), mBuilder.strokeColor);
        myGrad.setCornerRadius(DensityUtil.dp2px(mContext, mBuilder.cornerRadius));
